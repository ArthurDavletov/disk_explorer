...
class CustomFormatter(logging.Formatter):
    """Кастомный форматер для даты и времени.
    С поддержкой миллисекунд"""
...
class Logger(logging.Logger):
    ...
    Отличается от обычного логгера за счёт ротирования файлов,
    ...
    def __init__(self, name: str, level: int | str = 0):
        ...
        :param name: Имя логгера (от него зависят название файлов логов). Следует указывать ``__name__``
        :param level: Уровень логирования. По умолчанию логируются все действия (в частности ``'INFO'``).
